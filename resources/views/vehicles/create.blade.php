        ...
        <div style="grid-column: 1/-1;">
            ...
            <div class="row" style="gap:12px; flex-wrap:wrap;">
                <label class="btn btn-secondary btn-icon" style="display:flex; align-items:center; gap:8px;">
                    <input type="radio" name="vtype" value="auto" {{ old('vtype')==='auto' ? 'checked' : '' }}> 
                ...
                <label class="btn btn-secondary btn-icon" style="display:flex; align-items:center; gap:8px;">
                    <input type="radio" name="vtype" value="pickup" {{ old('vtype')==='pickup' ? 'checked' : '' }}> 
                    <span style="display:inline-flex; color:#374151;">
                ...
                <label class="btn btn-secondary btn-icon" style="display:flex; align-items:center; gap:8px;">
                    <input type="radio" name="vtype" value="furgoneta" {{ old('vtype')==='furgoneta' ? 'checked' : '' }}> 
                    <span style="display:inline-flex; color:#374151;">
                ...
                <label class="btn btn-secondary btn-icon" style="display:flex; align-items:center; gap:8px;">
                    <input type="radio" name="vtype" value="camion" {{ old('vtype')==='camion' ? 'checked' : '' }}> 
                    <span style="display:inline-flex; color:#374151;">
